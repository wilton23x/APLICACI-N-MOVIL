  ...
  Future<Database> get database async {
    ...
    _db = await openDatabase(
      ...
      onUpgrade: (db, oldVersion, newVersion) async {
        if (oldVersion < 2) {
          await db.execute('ALTER TABLE tasks ADD COLUMN foto_path TEXT');

          await db.execute('ALTER TABLE tasks ADD COLUMN latitud REAL');

          await db.execute('ALTER TABLE tasks ADD COLUMN longitud REAL');
        }
      },
    );
